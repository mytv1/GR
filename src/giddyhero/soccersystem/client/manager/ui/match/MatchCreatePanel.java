...
import giddyhero.soccersystem.client.manager.ui.match.MatchTeamPanel.TeamChoose;
...
public class MatchCreatePanel extends Composite {
	...
	interface MatchCreatePanelUiBinder extends UiBinder<Widget, MatchCreatePanel> {
	}

	public MatchCreatePanel() {
