...
public class PanelTeamAll extends FlowPanel {
	...
	private void initButtonCreate() {
		...
		btCreate.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				Window.open("Manager.html#"+HistoryToken.WINDOW_CREATE_TEAM, "window name", "width="+WindowCreateTeam.WIDTH+", height="+WindowCreateTeam.HEIGHT);
			}
		});
		add(btCreate);		
	}
