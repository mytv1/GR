...
public class GHTouchImage extends GHImage implements HasTouchHandlers, HasTapHandlers, 
	...
	public GHTouchImage(ImageResource resource) {
		super(resource);
		this.resource = resource;
		gestureUtility = new GestureUtility(this);
	}
	
	public GHTouchImage(String url) {
		super(url);
		gestureUtility = new GestureUtility(this);		
	}
	
	public GHTouchImage(ImageResource resource, ImageResource activeResource) {
		super(resource);
		this.resource = resource;
